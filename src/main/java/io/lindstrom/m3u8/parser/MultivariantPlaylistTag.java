...
enum MultivariantPlaylistTag implements Tag<MultivariantPlaylist, MultivariantPlaylist.Builder> {
    EXT_X_VERSION {
        @Override
        public void read(MultivariantPlaylist.Builder builder, String attributes, ParsingMode parsingMode) {
            builder.version(Integer.parseInt(attributes));
        }

        @Override
        public void write(MultivariantPlaylist playlist, TextBuilder textBuilder) {
    ...
    EXT_X_START {
        @Override
        public void read(MultivariantPlaylist.Builder builder, String attributes, ParsingMode parsingMode) throws PlaylistParserException {
    ...
    EXT_X_STREAM_INF {
        @Override
        public void read(MultivariantPlaylist.Builder builder, String attributes, ParsingMode parsingMode) {
            // Not used. This is handled by the MultivariantPlaylistParser directly.
        }
    ...
    static final Map<String, MultivariantPlaylistTag> tags = ParserUtils.toMap(values(), Tag::tag);
}