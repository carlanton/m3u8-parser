...
public enum SegmentKeyParser implements AttributeParser<SegmentKey, SegmentKey.Builder> {
    METHOD {
        @Override
    ...
    static TagParser<SegmentKey> parser(String tag) {
        return new DefaultTagParser<>(
                tag,
                SegmentKeyParser.class,
